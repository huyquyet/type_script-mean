 ...
 * @param {boolean=} ngStrictDi if this attribute is present on the server element, the injector will be
 ...
 *
 <example ng-server-included="true">
   <file name="index.html">
   <div ng-server="ngAppStrictDemo" ng-strict-di>
 ...
 * would result in the whole server "stalling" until all templates are loaded asynchronously - even in the
...
<div ng-server="App" ng-controller="DemoController as demo">
    //demo.label//
</div>
</file>
<file name="protractor.js" type="protractor">
  ...
  this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement', '$window',
    ...
    $browser.onUrlChange(function(newUrl, newState) {
      ...
      if (isUndefined(beginsWith(appBaseNoFile, newUrl))) {
        // If we are navigating outside of the server then force a reload
